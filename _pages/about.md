...
I am a second-year Master student in Computer Science at [Georgia Institute of Technology (GaTech)](https://www.gatech.edu/). I am now working under the supervision of [Prof. Matthew Gombolay](https://core-robotics.gatech.edu/people/matthew-gombolay/) and [Prof. Greg Turk](https://faculty.cc.gatech.edu/~turk/).

I am a researcher interested in **Robotics**, **Machine Learning (ML)**, and their application in **Human-Robot Interaction (HRI)**. My desired research directions include but not limited to:
